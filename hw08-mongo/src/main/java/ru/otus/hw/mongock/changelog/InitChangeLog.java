...
public class InitChangeLog {
    ...
    @ChangeSet(order = "001", id = "addData", author = "user", runAlways = true)
    public void addData(
        ...
        var book1 = bookRepository.save(new Book("1", "Book_1", author1, genre1));
        var book2 = bookRepository.save(new Book("2", "Book_2", author2, genre2));
        var book3 = bookRepository.save(new Book("3", "Book_3", author3, genre3));
        ...
        commentRepository.save(new Comment("5", "Comment_5", book3));
