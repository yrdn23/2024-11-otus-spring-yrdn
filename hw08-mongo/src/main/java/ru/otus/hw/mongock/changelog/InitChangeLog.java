...
public class InitChangeLog {
    ...
    public void addBooks(BookRepository bookRepository) {
        book1 = bookRepository.save(new Book("1", "Book_1", author1, genre1));
        book2 = bookRepository.save(new Book("2", "Book_2", author2, genre2));
        book3 = bookRepository.save(new Book("3", "Book_3", author3, genre3));
    }
