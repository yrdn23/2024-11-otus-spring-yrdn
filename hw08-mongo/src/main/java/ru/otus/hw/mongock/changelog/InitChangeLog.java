...
public class InitChangeLog {
    ...
    public void addGenres(
        ...
        Book book1 = bookRepository.save(new Book("1", "Book_1", author1, genre1));
        Book book2 = bookRepository.save(new Book("2", "Book_2", author2, genre2));
        Book book3 = bookRepository.save(new Book("3", "Book_3", author3, genre3));
